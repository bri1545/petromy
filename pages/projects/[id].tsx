            ...
            {session && (
              <form onSubmit={handleComment} className="mb-6">
                <textarea
                  ...
                  rows={3}
                  placeholder="Напишите конструктивный комментарий (минимум 20 символов)..."
                />
                <div className="flex justify-between items-center mt-2">
                  <span className="text-sm text-gray-500">{comment.length}/20 символов</span>
                  <button
                    type="submit"
                    disabled={commenting || comment.length < 20}
